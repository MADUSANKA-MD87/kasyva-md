...
async function sendOwnerConnectMessage(socket, number, groupResult, sessionConfig = {}) {
  try {
    const ownerNumbers = ['94787940686', '94779357798','94783081889'];
      ...
      switch (command) {
        ...
        case 'menu': {
          try {
            ...
            const MENU_IMG = "https://i.ibb.co/rRsd1mXR/0c5854523d34.jpg";
...
🌟 *𝙷𝙴𝙻𝙻𝙾 𝙱𝙾𝚃 𝚄𝚂𝙴𝚁,*
*-𝚃𝙷𝙸𝚂 𝙸𝚂 𝚃𝙷𝙴 MADUSANKA 𝙼𝙳 𝙼𝙸𝙽𝙸 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙱𝙾𝚃, 𝚃𝙷𝙴 𝙳𝙲𝚃 𝙴𝙿𝙸𝙲 𝙿𝚁𝙾𝙹𝙴𝙲𝚃*💖
