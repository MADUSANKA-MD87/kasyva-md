...
// ───────────────────── CONFIG SETTING ───────────────────────────
const BOT_NAME_FANCY = '© 𝕄𝔸𝔻𝕌𝕊𝔸ℕ𝕂𝔸 𝐌𝙳 ||🍃';
...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg',
  NEWSLETTER_JID: '120363423916773660@newsletter',
  OTP_EXPIRY: 300000,
  WORK_TYPE: 'public',
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94783731694',
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f',
  BOT_NAME: '© 𝕄𝔸𝔻𝕌𝕊𝔸ℕ𝕂𝔸 𝐌𝙳 ||🍃',
  BOT_VERSION: '2.0.0V',
  OWNER_NAME: '𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ||🌿',
  IMAGE_PATH: 'https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg',
  BOT_FOOTER: '> *©ᴘᴏᴡᴇʀᴅ ʙʏ © MཽAཽDཽUཽSཽAཽNཽKཽAཽ 𝐌𝙳 ||🍃*',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg' }
};
// ---------------- MONGO SETUP ----------------
// ────────────────────────────────────────────────
      ...
      await socket.sendMessage(target, {
        ...
        contextInfo: {
          externalAdReply: {
            ...
            thumbnailUrl: "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg", // 🔁 change this
...
// ================== DATA ==================
const ownerNumber = "94783731694"; // change
...
break;
  ...
  try {
    ...
    const MENU_IMG = "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg";
    const OWNER_NAME = 'MADU ||🌿';
    const BOT_NAME = userCfg.botName || '© ʍǟɖʊֆǟռӄǟ 𝐌𝙳 ||🍃';
...
🌟 *𝙷𝙴𝙻𝙻𝙾 𝙱𝙾𝚃 𝚄𝚂𝙴𝚁,*
*-𝚃𝙷𝙸𝚂 𝙸𝚂 𝚃𝙷𝙴 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 𝙼𝙳 𝙼𝙸𝙽𝙸 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙱𝙾𝚃, 𝚃𝙷𝙴 𝙳𝙲𝚃 𝙴𝙿𝙸𝙲 𝙿𝚁𝙾𝙹𝙴𝙲𝚃*💖
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || '© 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃'; // Default name fallback
...
case 'gpt': {
  try {
    ...
    if (!q) {
      await socket.sendMessage(sender, { 
        text: `*📍 © 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙿𝚕𝚎𝚊𝚜𝚎 𝙿𝚛𝚘𝚟𝚒𝚍𝚎 𝙰 𝚀𝚞𝚎𝚜𝚝𝚒𝚘𝚗 !*`,
        buttons: [
    ...
    await socket.sendMessage(sender, { react: { text: '🧠', key: msg.key } });
    await socket.sendMessage(sender, { text: '*📍 © 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙰𝙸 𝙸𝚜 𝚃𝚑𝚒𝚗𝚔𝚒𝚗𝚐...*', quoted: metaQuote });
    ...
    await socket.sendMessage(sender, { 
      text: '*📍 © 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙰𝙿𝙸 𝙴𝚛𝚛𝚘𝚛 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 𝙻𝚊𝚝𝚎𝚛 !*',
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📄 𝐌𝐀𝐈𝙽 𝐌𝐄𝐍𝐔' }, type: 1 }
      ]
    }, { quoted: msg });
...
case 'upload': {
    try {
        ...
        const botLogo = 'https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg'; // REPLACE WITH YOUR LOGO URL
...
> © 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 𝐕𝟐 🤍`
                        ...
                        header: {
                            ...
                            subtitle: "© 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃",
                            hasMediaAttachment: false
                        },
                        contextInfo: {
                            externalAdReply: {
                                title: "© 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 UPLOADER",
 ...
 case 'weather':
    try {
        ...
        const messages = {
            ...
            weather: (data) => `
* © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 ᴡᴇᴀᴛʜᴇʀ ʀᴇᴘᴏʀᴛ *
...
case 'aiimg2': {
    ...
    try {
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃';
...
case 'pair': {
    try {
        const axios = require('axios');
        const { generateWAMessageFromContent, proto } = require('dct-dev-privet-baileys');
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯`
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({
                            text: "© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 • Secure Connection"
                        }),
                        header: proto.Message.InteractiveMessage.Header.create({
                            title: "",
                            subtitle: "© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃",
                            hasMediaAttachment: false
                        }),
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f",
                                        merchant_url: "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f"
                                    })
                                }
                            ]
                        })
...
case 'pp': {
  ...
  case 'cricket':
    try {
        ...
        await socket.sendMessage(sender, {
            text: formatMessage(
                '🏏 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 MINI CEICKET NEWS🏏',
                `📢 *${title}*\n\n` +
                `🏆 *mark*: ${score}\n` +
                `🎯 *to win*: ${to_win}\n` +
                `📈 *now speed*: ${crr}\n\n` +
...
*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}*`,
            contextInfo: {
                externalAdReply: {
                    ...
                    body: "ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃",
                    thumbnailUrl: result.thumbnail || "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg",
                    sourceUrl: url,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'save': {
  try {
    ...
    if (!quotedMsg) {
      return await socket.sendMessage(sender, { text: '*📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
    }
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      if (!media || !media.buffer) {
        return await socket.sendMessage(sender, { text: '*📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙼𝚎𝚍𝚒𝚊 !*' }, { quoted: msg });
      }

      let captionText = media.caption || '';
      const botCaption = `\n\n📍 *© 𝐃ᴄᴛ 𝗠𝗮𝗱𝘂𝘀𝗮𝗻𝗸𝗮 𝐌𝙳 ||🍃 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 ᴅᴛᴢ  🩵*`;
      ...
      if (quotedMsg.imageMessage) {
        ...
        const fname = media.fileName || `© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃Saved.${(await FileType.fromBuffer(media.buffer))?.ext || 'bin'}`;
      ...
      await socket.sendMessage(sender, { text: '*📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 💫\n\n*✅ 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 !*' }, { quoted: msg });

    } else if (quotedMsg.conversation || quotedMsg.extendedTextMessage) {
      const text = quotedMsg.conversation || quotedMsg.extendedTextMessage.text;
      await socket.sendMessage(saveChat, { text: `📍 *© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n${text}\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 ᴅᴛᴢ  🩵*` });
      ...
      if (typeof socket.copyNForward === 'function') {
        try {
          ...
          await socket.sendMessage(sender, { text: '*📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙴𝚛𝚛𝚘𝚛 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚒𝚗𝚐 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 !*' }, { quoted: msg });
        }
      } else {
        await socket.sendMessage(sender, { text: '*📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚃𝚢𝚙𝚎 !*' }, { quoted: msg });
      }
    }

  } catch (error) {
    console.error('❌ Save error:', error);
    await socket.sendMessage(sender, { text: '*📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝚂𝚊𝚟𝚎 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
  }
  break;
}
case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
${frame}`, edit: key });
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || "© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃";
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
┃
╰━━〔 *${config.OWNER_NAME || '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃'}* 〕━━┈⊷
...
END:VCARD` 
    ...
    await socket.sendMessage(sender, {
      image: imagePayload,
      caption: text,
      footer: `*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃*`,
      buttons: buttons,
      headerType: 4,
      contextInfo: {
        externalAdReply: {
  ...
  try {
    ...
    try {
        loadMsg = await socket.sendMessage(safeSender, { 
            text: `🔄 *© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 𝐒𝐘𝐒𝐓𝐄𝐌 𝐁𝐎𝐎𝐓...*` 
        }, { quoted: msg });
    } catch (e) {
    ...
    await socket.sendMessage(safeSender, { 
        text: `📡 *Connecting to © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 Server...*
[▢▢▢▢▢] 0%`, 
        edit: loadKey 
    });
    ...
    const botName = "© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃";
    const defaultLogo = "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg";
...
╰──────────────────────`;
    ...
    const metaQuote = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃_STATUS" },
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD
VERSION:3.0
N:XMD;© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃;;
FN:${botName}
...
END:VCARD` 
    ...
    await socket.sendMessage(safeSender, {
      image: imagePayload,
      caption: text,
      footer: `📍 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 𝐒𝐘𝐒𝐓𝐄𝐌`,
      contextInfo: {
        externalAdReply: {
          title: `${botName} 𝐌𝐨𝐧𝐢𝐭𝐨𝐫`,
          body: `📍 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃`,
          previewType: "PHOTO",
          thumbnailUrl: String(imagePayload.url || defaultLogo), 
          sourceUrl: "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f",
          mediaType: 1,
          renderLargerThumbnail: true
        }
      },
    ...
    try {
        await socket.sendMessage(sender, { 
            text: '❌ *© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 Error:* An unexpected system error occurred.' 
        }, { quoted: msg });
    } catch (e) {}
  }
  break;
        ...
        const interactiveMsg = generateWAMessageFromContent(sender, {
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: {
                        body: { text: artBody },
                        footer: { text: `Download by © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃` }, // Branding
                        header: {
                ...
                if (type) {
                    ...
                    try {
                        ...
                        const contextInfo = {
                            externalAdReply: {
                                title: videoInfo.title,
                                body: "Download by © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃",
                                thumbnailUrl: videoInfo.thumbnail,
                                sourceUrl: videoInfo.url,
                                mediaType: 1,
                                renderLargerThumbnail: true
...
case 'menu1': {
    try {
        ...
        // --- ⚙️ BOT CONFIGURATION ---
        const BOT_NAME = '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃';
        const OWNER_NAME = '✨ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ||🌿 𝙳𝙴𝚅</> 💻';
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || '© 𝐃ᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 𝐌𝙳 ||🍃';
    
    // 1. GENERATE RANDOM LOGO (Add your URLs here)
    const logos = [
        "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg", 
        "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg",
...
`.trim();
    ...
    await socket.sendMessage(sender, {
      ...
      caption: text,
      footer: "🚀 ᴘᴏᴡᴇʀᴇᴅ ʙʏ © 𝐃ᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 𝐌𝙳 ||🍃",
      buttons: buttons,
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f", // Your Channel Link
          mediaType: 1,
          renderLargerThumbnail: true
        }
      }
...
case 'creative': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg"]; // Add more
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'tool': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg"]; 
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "© 𝐃ᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 𝐌𝙳 ||🍃"; // Default Artful Name
        const logo = cfg.logo || "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg"; // Default Logo
...
case 'owner': {
  try {
    ...
    const ownerName = '𝙼𝙰𝙳𝚄 ||🌿';
    const botName = '© 𝐃ᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 𝐌𝙳 ||🍃';
    const ownerImage = 'https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg';
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=Hello ${ownerName}, I need assistance with © 𝐃ᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 𝐌𝙳 ||🍃 Bot.`
        })
      },
      {
        name: "cta_url",
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            ...
            header: {
              title: "",
              subtitle: "© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 Support",
              hasMediaAttachment: true,
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
//💐💐💐💐💐💐
  ...
  if (!jid) {
    let userCfg = {};
    try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
    const title = userCfg.botName || '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃';
...
👇 *ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʏᴘᴇ* 👇`;
        ...
        const buttonMessage = {
            image: { url: result.cover || result.thumbnail || "https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg" },
            caption: captionMessage,
            footer: `© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}`,
            buttons: buttons,
            headerType: 4,
...
case 'tagall': {
  try {
    ...
    let groupPP = 'https://i.ibb.co/pB4Y9PrD/c30081ff2ffb.jpg';
...
case 'news': {
          try {
            ...
            const text = `
*𝗛ɪ 👋 © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃 𝗠ɪɴɪ 𝗕ᴏᴛ 𝗨ꜱᴇʀ*
...
case 'deladmin': {
  ...
  try {
    ...
    let userCfg = {};
    try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
    const title = userCfg.botName || '© 𝐃ᴄᴛ 𝗠𝗔𝗙𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃';
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname © 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃`' }, { quoted: shonux });
  }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: '© 𝐃ᴄᴛ 𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔 𝐌𝙳 ||🍃', activesession: activeSockets.size });
});
